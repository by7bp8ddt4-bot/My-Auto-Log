...
import { isSameService, getLogServiceTypes } from '../utils/serviceMatcher';

// Re-export for backward compatibility — consumers that only need these utilities
// should import from '../utils/serviceMatcher' directly to avoid pulling in
// the 192KB maintenance-schedules.js data file.
export { isSameService, getLogServiceTypes };
