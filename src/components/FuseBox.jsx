    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-800/80 border border-slate-700 text-white text-base placeholder:text-slate-400 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/30 transition-all"
        />
        {searchTerm && (
          <button
            onClick={() => setSearch('')}
          ...
          return (
            <div key={panelIdx} className="rounded-2xl border border-slate-800 bg-slate-900/50 overflow-hidden">
              ...
              >
                ...
                <svg
                  className={`w-4 h-4 text-slate-400 shrink-0 mt-2 transition-transform ${isExpanded ? 'rotate-180' : ''}`}
                ...
                <div className="border-t border-slate-800">
                  ...
                  {hasSearch && totalFiltered === 0 ? (
                    <div className="p-6 text-center">
                      <p className="text-xs text-slate-400">No matching fuses or relays in this panel.</p>
                    </div>
                  ) : (
                            ...
                            <>
                              ...
                              <tr>
                                <td colSpan={4} className="px-4 py-2 bg-slate-800/30">
                                  <span className="text-[11px] font-semibold text-purple-400 uppercase tracking-wider">Relays</span>
                                </td>
                              </tr>
      ...
      {/* Summary footer */}
      <div className="mt-6 flex items-center gap-3 text-[11px] text-slate-500 justify-center">
