...
// ============================================================================
const HIN_MIC_MAP = {
  YAM: { make: 'Yamaha', country: 'Japan', engineSize: '1.8L' },
  YVE: { make: 'Sea-Doo (BRP)', country: 'Canada', engineSize: '1.5L' },
  KAW: { make: 'Kawasaki', country: 'Japan', engineSize: '1.5L' },
  HON: { make: 'Honda Marine', country: 'Japan', engineSize: '1.2L' },
  BRP: { make: 'BRP', country: 'Canada', engineSize: '1.5L' },
  SER: { make: 'Sea Ray', country: 'USA', engineSize: '6.2L' },
  ...
  TIG: { make: 'Tige', country: 'USA', engineSize: '6.0L' },
  MAS: { make: 'MasterCraft', country: 'USA', engineSize: '6.2L' },
  MAL: { make: 'Malibu Boats', country: 'USA', engineSize: '6.0L' },
  COR: { make: 'Correct Craft', country: 'USA', engineSize: '5.3L' },
  NAU: { make: 'Nautique', country: 'USA', engineSize: '6.0L' },
...
export async function decodeHin(hin) {
  ...
  const data = {
    ...
    engineSize: micInfo?.engineSize || null,
